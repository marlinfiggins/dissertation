...
\begin{itemize}
  \item \emph{Selection} is the process by which individuals have higher fitness \tbc{this would seem more naturally to me as `leave more offspring' rather than `have higher fitness', although I admit these concepts are synonymous. I just don't think of having higher fitness as a `process'} in certain environments.
  \item \emph{Evolution} is the change in the genetic composition of the population over time due to selection and heritable variation. \tbc{Evolution can also occur due to genetic drift}
\end{itemize}
