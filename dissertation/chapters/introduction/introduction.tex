...
To account this, we need to assess how population structure affects relative fitness in real-time and how this will carry into the future.
...
\begin{itemize}
        ...
        \item Shows the limitations of statistical models for longer-term forecasts, emphasizing the need for more comprehensive approaches.
...
This chapter introduces several important innovations, including the selective pressure metric, a latent factor model, and a focus on immune escape as a critical factor for explaining fitness dynamics and viral evolution.

\noindent\textbf{Key contributions}:
\begin{itemize}
  \item Development of a Gaussian Process model for estimating time-varying relative fitness, tracking how variants evolve in real-time regardless of underlying mechanism.
  ...
  \item Demonstrates the utility of the selective pressure metric for early detection of variant growth, improving the ability to intervene before they dominate epidemiologically.
\end{itemize}
...
\begin{itemize}
  ...
  \item Validation of the framework’s predictive accuracy, highlighting its potential for real-time monitoring and broader application to other rapidly evolving pathogens.
\end{itemize}
