...
% ========== Chapter 2
\include{chapters/rt-from-frequency-dynamics/rt-from-frequency-dynamics}

% ========== Chapter 3
\include{chapters/ncov-forecasting-fit/ncov-forecasting-fit}

% ========== Chapter 3
\include{chapters/relative-fitness-mechanisms/relative-fitness-mechanisms}

% ========== Chapter 5
\include{chapters/ncov-escape/ncov-escape}

% ========== Chapter 6
\include{chapters/operationalizing-forecasts/operationalizing-forecasts}

% ========== Chapter 7
\include{chapters/discussion-conclusion/discussion-conclusion}
...
\bibliography{dissertation_Figgins_cleaned}
%
% ==========   Appendices
%
\appendix
...
\include{chapters/rt-from-frequency-dynamics/appendix}
\include{chapters/ncov-forecasting-fit/appendix}
\include{chapters/relative-fitness-mechanisms/appendix}
\include{chapters/ncov-escape/appendix}
